          ...
          <div class="container-fluid">
              <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="index.html">
                      ...
                      <span class="logo-name">لوحة التحكم</span>
                  </a>
              </div>
...
<main>
 ...
 <aside id="leftsidebar" class="sidebar">
        ...
        <ul class="list">
            <li class="sidebar-user-panel active">
                ...
                <div class="profile-usertitle">
                    <div class="sidebar-userpic-name"> ريهام الشاعري  </div>
            ...
            <li class="active">
                ...
                <ul class="ml-menu">
                   ...
                   --> 
                    ...
                    <li class="active">
                        <a asp-controller="PurchaseOrder" asp-action="Create"> التحليلات </a>
                    </li>
    ...
    <!-- #Menu -->
        ...
        <div class="col bg-info">@yield('content')</div>
    </div>
</main>
<footer class="bg-danger">gr</footer>
